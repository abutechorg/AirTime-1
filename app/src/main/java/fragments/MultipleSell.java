...
//        }
    ...
    private void promptToRechargeWallet(double currentBalance) {
        ...
        dialog.setCancelable(false);
        dialog.setCanceledOnTouchOutside(false);
        dialog.setContentView(R.layout.promp_wallet_recharge);

        close = (TextView) dialog.findViewById(R.id.close);
        close.setTypeface(font, Typeface.BOLD);
        title = (TextView) dialog.findViewById(R.id.title);
        title.setTypeface(font, Typeface.BOLD);
        contentMessage = (TextView) dialog.findViewById(R.id.boxMessage);
...
//        contentMessage.append(notifText);
        ...
        wAmount = (EditText) dialog.findViewById(R.id.amount);
        final RechargeWalletUtil rechargeWalletUtil = new RechargeWalletUtil(this, getActivity(), msisdn, token);
        //handle buttons click
        visa = (ImageView) dialog.findViewById(R.id.visaButton);
        mc = (ImageView) dialog.findViewById(R.id.mcButton);
        verve = (ImageView) dialog.findViewById(R.id.verveButton);
