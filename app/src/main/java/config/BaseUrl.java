...
//    public static final String baseUrl="http://41.74.172.132:8080/AirtimeRechargeSystem/";//must end with(/)
    ...
    public static final String helpUrl = "http://airtimeweb.oltranz.com/faces/mhelp.xhtml";
    public static final String termsUrl = "http://airtimeweb.oltranz.com/faces/mterm.xhtml";
